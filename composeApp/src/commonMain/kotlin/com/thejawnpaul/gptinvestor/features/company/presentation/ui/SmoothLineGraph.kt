...
fun generateSmoothPath(data: List<GraphPoint>, size: Size): Path {
    ...
    data.forEachIndexed { i, balance ->
        ...
        val controlPoint1X = (balanceX + previousPointX) / 2f
        val controlPoint1Y = previousPointY
        val controlPoint2X = (balanceX + previousPointX) / 2f
        val controlPoint2Y = balanceY
        path.cubicTo(
            controlPoint1X,
            controlPoint1Y,
            controlPoint2X,
