...
) : BaseUseCase<String, CompanyBrief>(coroutineScope, dispatcher) {

    override suspend fun run(params: String): Flow<Either<Failure, CompanyBrief>> = repository.getCompanyBrief(params)
}
