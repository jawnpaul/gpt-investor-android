...
import com.thejawnpaul.gptinvestor.error_loading_tidbits
...
import com.thejawnpaul.gptinvestor.load_more
import com.thejawnpaul.gptinvestor.no_tidbits_found
    ...
    Scaffold(
        ...
        topBar = {
            Row(
                ...
                Text(
                    text = stringResource(Res.string.saved_tidbits),
