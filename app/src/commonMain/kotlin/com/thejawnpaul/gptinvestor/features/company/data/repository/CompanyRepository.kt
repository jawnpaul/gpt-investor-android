...
import com.thejawnpaul.gptinvestor.features.company.domain.model.toDomainObject
    ...
    override suspend fun getAllCompanies(): Flow<Either<Failure, List<Company>>> = flow {
        try {
            ...
            response.onSuccess { data ->
                val remoteEntities = data.map { companyRemote -> companyRemote.toEntity() }
    ...
    override suspend fun getTrendingCompanies(): Flow<Either<Failure, List<TrendingCompany>>> =
        flow {
            try {
                ...
                response.onSuccess { trendingRemoteList ->
