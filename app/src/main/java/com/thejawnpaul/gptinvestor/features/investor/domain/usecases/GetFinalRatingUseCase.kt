...
class GetFinalRatingUseCase @Inject constructor(@IoDispatcher private val dispatcher: CoroutineDispatcher, coroutineScope: CoroutineScope, private val repository: IInvestorRepository) :
    BaseUseCase<FinalAnalysisRequest, String>(coroutineScope, dispatcher) {

    override suspend fun run(params: FinalAnalysisRequest): Flow<Either<Failure, String>> = repository.getFinalAnalysis(params)
}
