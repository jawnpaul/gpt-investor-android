...
class GetCompanyDetailInputResponseUseCase(
    ...
    override suspend fun run(params: CompanyPrompt): Flow<Either<Failure, Conversation>> = repository.getCompanyInputResponse(params)
}
