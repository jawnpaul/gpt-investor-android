...
class ConversationRepository(
    ...
    override suspend fun getInputResponse(prompt: ConversationPrompt): Flow<Either<Failure, Conversation>> = flow {
        ...
        try {
            ...
            Logger.e(conversation.id.toString())
        ...
        try {
            ...
            while (!channel.isClosedForRead) {
                ...
                if (line.startsWith("event:")) {
                    ...
                    Logger.d("SSE Event: $currentEvent, Data: $data")
                    when (currentEvent) {
                        "text" -> {
                            try {
                                ...
                                Logger.e("Error parsing text event")
                            }
                        }

                        "conversation_id" -> {
                            try {
                                val conversationIdResponse =
                                    json.decodeFromString<ConversationIdResponse>(
                                        data
                                    )
                                conversationIdResponse.id.let { remoteId ->
                                    Logger.d("Syncing Remote ID: $remoteId")
                                ...
                                Logger.e("Error parsing conversation_id event")
                            }
                        }
                        ...
                        "entity" -> {
                            try {
                                ...
                                Logger.e("Error parsing entity event")
                            }
                        }
                        ...
                        "suggestions" -> {
                            try {
                                ...
                                Logger.e("Error parsing suggestions event")
                            }
                        }
                        ...
                        "title" -> {
                            try {
                                val titleResponse =
                                    json.decodeFromString<ConversationTitleResponse>(
                                        data
                                    )
                                ...
                                Logger.e("Error parsing title event")
                            }
                        }
                        ...
                        "error" -> {
                            try {
                                ...
                                Logger.e("Error parsing error event")
                            }
                        }

                        "completion" -> {
                            Logger.d("SSE Stream Completed")
            ...
            Logger.e("Error during SSE stream")
            val updatedMessages = ArrayList(currentConversation.messageList)
            val index =
